...
Run any of the following commands in R to open the corresponding help page
(clickable links are available on the
[package website](https://jiakun0611.github.io/nonprobsampling/)):
