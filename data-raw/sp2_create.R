...
# Stratum 6238 contains a single PSU (psu_sp2 = 2, n = 6); combine it with
# the adjacent stratum 6237 to avoid a single PSU stratum in the survey design.
sp2 <- sp2 %>%
  mutate(strata_sp2 = ifelse(strata_sp2 == 6238, 6237, strata_sp2))
