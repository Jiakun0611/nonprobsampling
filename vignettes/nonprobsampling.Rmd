...
For a numeric outcome, `pwmean()` estimates the overall population mean. Here, `psa_level` is a numeric outcome, so the output is printed as a mean. (Binary 0/1 outcomes are treated as numeric and are printed as means.)
```{r pwmean-numeric}
